  ...
  return <div className="page-stack track-page">
      <section className="cycle-summary">
        ...
        <div className="cycle-summary-copy">
          ...
          <h3 class="painkiller-text">You have 1 painkiller left</h3>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="insight-list health-card">
          <div className="insight-row">
            <span className="insight-icon mint"><Egg size={20} className="lucide lucide-egg mt-2.5 mb-2.5 ml-2.5" /></span>
            <div>
