...
export default function Profile() {
  ...
  return <div className="page-stack profile-page">
      ...
      <section className="profile-highlight health-card">
        <span className="highlight-icon mt-0 mb-0 text-center pt-[3px] pb-[3px]"><HeartHandshake size={23} className="lucide lucide-heart-handshake lucide lucide-heart-handshake pt-0 pb-0 mt-[7px] mb-[7px] ml-2.5" /></span>
        <div>
